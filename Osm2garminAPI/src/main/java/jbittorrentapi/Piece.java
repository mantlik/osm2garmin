...
public class Piece {
    ...
    private TreeMap<Integer, Long> filesAndoffset;
    /**
     ...
     */
    public Piece(int index, int length, int blockSize, byte[] sha1, TreeMap<Integer, Long> m) {
        this.index = index;
        this.length = length;
    ...
    public void setFileAndOffset(int file, long offset){
